...
_upterm_ci()
{
    ...
    flags+=("--continue-file=")
    two_word_flags+=("--continue-file")
    local_nonpersistent_flags+=("--continue-file")
    local_nonpersistent_flags+=("--continue-file=")
    flags+=("--force-command=")
    ...
    flags+=("--limit-access-to-actor")
    local_nonpersistent_flags+=("--limit-access-to-actor")
    flags+=("--limit-access-to-users=")
    two_word_flags+=("--limit-access-to-users")
    local_nonpersistent_flags+=("--limit-access-to-users")
    local_nonpersistent_flags+=("--limit-access-to-users=")
    flags+=("--log-session-output")
    local_nonpersistent_flags+=("--log-session-output")
    flags+=("--name=")
    two_word_flags+=("--name")
    flags+=("--no-sftp")
    flags+=("--private-key=")
